...
col = {"col_1" : 2, "col_2" : 12, "col_3" : 11, "col_4" : 14 , "col_5" : 18}
pat = [1, 2, 3]
data = []
...
for j in pat:
    ...
    while(i<35):
        ...
        sleep_hour = random.randrange(21, 27)
        col_2 = str(sleep_hour) + ":" + str(random.randrange(0, 59)) if sleep_hour < 24 else str(sleep_hour - 24) + ":" + str(random.randrange(0, 59))  # 기상시간
        col_3 = str(random.randrange(5, 11)) + ":" + str(random.randrange(0, 59)) # 취침시간
        col_4 = round(random.random())  # 파국반응 
        col_5 = random.randrange(1, 10) # 술
        ...
        data.append((j, s.strftime("%Y-%m-%d"), col['col_5'], col_5))   
        a = timedelta(days=1)
        s = s + a
        i += 1
