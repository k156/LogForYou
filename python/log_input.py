...
col = {"col_1" : 2, "col_2" : 11, "col_3" : 12, "col_5" : 14, "col_4" : 18}
pat = [1, 2, 3]
data = []
...
for j in pat:
    ...
    while(i<35):
        ...
        time = random.randrange(21, 27)
        time1 = time if time < 24 else time - 24
        col_3 = str(time1) + ":" + str(random.randrange(0, 59)) # 취침시간
        col_5 = round(random.random())  # 파국반응 
