...
# sql_insert = "insert into departments(department) value(%s)"
isStart = True
...
# csvFile = codecs.open("C:\\Users\\JK\\Downloads\\진료과.csv", "r", "utf-8")
# csvFile = codecs.open("/Users/mac/Downloads/disease code - 시트11.csv", "r", "utf-8")
csvFile = codecs.open("C:\\workspace\\LogForYou\\data\\disease codes.csv", "r", "utf-8")
# csvFile = codecs.open("C:\\Users\\JK\\Downloads\\usercol.csv", "r", "utf-8")
